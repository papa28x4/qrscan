    ...
    <div class="container">
        <div class="row">
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Add an Item</h5>
                        <form action="{{route('items.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-10">
                                    <input name="serial_no" type="text" class="form-control" id="serial_no" value="{{old('serial_no')}}" placeholder="Enter the Serial Number">
                                    @error('serial_no')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="product" name="product" class="form-control" >
                                        ...
                                        <option  
                                            @if(old('product') == $product->id) selected  @endif value="{{$product->id}}">
                                            {{$product->name}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-10">
                                <input name="color" type="text" class="form-control" id="color" value="{{old('color')}}" placeholder="Enter the color">
                                @error('color')
                                <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="user" name="user" class="form-control" >
                                        ...
                                        <option  
                                            @if(old('user') == $user->id) selected  @endif value="{{$user->id}}">
                                            {{$user->fullname()}}
                                        </option>
                                        @endforeach
                                    </select>
                          ...
                          <div class="d-flex justify-content-center mt-4">
                            ...
                            <button class="btn btn-primary mt-3" type="submit">Create Item</button>
                          </div>
