    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 flex-end text-right mb-5">Edit Brand</h5>
                        <form action="{{route('brands.update', $brand->slug)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                           @method('put')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 mb-4">
                                    ...
                                    <input name="name" type="text" class="form-control" id="name" value="{{old('name') ?? $brand->name}}" placeholder="Enter a brand">
                                    @error('name')
                            ...
                            <button class="btn btn-success mt-3" type="submit">Update Brand</button>
                        </form>
                    </div>
                </div>
            </div>
