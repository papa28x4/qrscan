    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 flex-end text-right mb-5">New Role</h5>
                        <form action="{{route('roles.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 mb-4">
                                    ...
                                    <input name="name" type="text" class="form-control" id="name" value="{{old('name')}}" placeholder="Enter a Role">
                                    @error('name')
                            ...
                            <button class="btn btn-success mt-3" type="submit">Create Role</button>
                        </form>
                    </div>
                </div>
            </div>
